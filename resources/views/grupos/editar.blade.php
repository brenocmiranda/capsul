...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form method="POST" action="{{ route('grupos.editando', $grupo->id) }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label class="custom-switch px-0">
                                        <input type="checkbox" name="ativo" class="custom-switch-input" {{($grupo->ativo == 1 ? ' checked' : '')}}>
                        ...
                        <div class="form-group col-10">
                            ...
                            <div class="d-flex mb-4 mx-auto">
                                <div class="col-3 border rounded-lg mx-1 text-center bg-white border-primary" id="variante1" style="cursor: pointer">
                                    <div class="my-3">
                                        <label class="colorinput mx-2 d-flex">
                                            <input type="radio" name="tipo" value="pf" class="colorinput-input" {{($grupo->tipo == 'pf' ? ' checked' : '')}}>
                                ...
                                <div class="col-3 border rounded-lg mx-1 text-center bg-white" id="variante2" style="cursor: pointer">
                                    <div class="my-3">
                                        <label class="colorinput mx-2 d-flex">
                                            <input type="radio" name="tipo" value="pj" class="colorinput-input" {{($grupo->tipo == 'pj' ? ' checked' : '')}}>
                                            <span class="colorinput-color bg-light border rounded-circle"></span>
                ...
                <div class="card" id="card-2">
                    ...
                    <div class="card-body">
                        <div class="form-group input-group col-3">
                            ...
                            <input type="text" class="form-control currency h-100" value="{{$grupo->pedido_minimo}}" name="pedido_minimo">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="from-group col-12">
                                ...
                                <div class="d-flex mb-4 mx-auto">
                                    <div class="col-2 border rounded-lg mx-1 text-center bg-white border-primary" id="variante3" style="cursor: pointer">
                                        <div class="my-3">
                                            <label class="colorinput mx-2 d-flex">
                                                <input type="radio" name="operacao" value="adicionar" class="colorinput-input" {{($grupo->operacao == 'adicionar' ? ' checked' : '')}}>
                                                <span class="colorinput-color bg-light border rounded-circle"></span>
                                    ...
                                    <div class="col-2 border rounded-lg mx-1 text-center bg-white" id="variante4" style="cursor: pointer">
                                        <div class="my-3">
                                            <label class="colorinput mx-2 d-flex">
                                                <input type="radio" name="operacao" value="subtrair" class="colorinput-input" {{($grupo->operacao == 'subtrair' ? ' checked' : '')}}>
                                                <span class="colorinput-color bg-light border rounded-circle"></span>
                        ...
                        <div class="row mb-3">
                            <div class="from-group col-2">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control h-100" value="{{$grupo->porcentagem}}" name="porcentagem">
                ...
                <div class="card" id="card-4">
                    <div class="card-header">
                        ...
                        <label class="custom-switch px-5">
                            <input type="checkbox" name="inserrir_novos_clientes" class="custom-switch-input" {{($grupo->inserrir_novos_clientes == 's' ? ' checked' : '')}}>
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description"><b>Ativo</b></span>
                        </label>
                    </div>
