...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form method="POST" action="{{ route('marcas.editando', $marca->id) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group col-12">
                            <label class="custom-switch px-0">
                                <input type="checkbox" name="ativo" class="custom-switch-input" {{($marca->ativo == 's' ? ' checked' : '')}}>
                                <span class="custom-switch-indicator"></span>
                                <span class="custom-switch-description"><b>Ativo</b></span>
                            </label>
                            <label class="custom-switch px-0" style="margin-left: 30px;">
                                <input type="checkbox" name="mostrar_na_home" class="custom-switch-input" {{($marca->mostrar_na_home == 's' ? ' checked' : '')}}>
                                ...
                                <div class="row">
                                  <div class="col-10">
                                    <div class="border p-3 col-12 rounded text-center">
                                      <img class="w-100" id="PreviewImage" src="{{ (isset($marca->RelationImagens1->caminho) ? asset('storage/app').'/'.$marca->RelationImagens1->caminho.'?'.rand() : asset('public/img/product.png').'?'.rand()) }}" style="height: 240px;" >
