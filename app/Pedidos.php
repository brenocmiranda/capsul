...
class Pedidos extends Model
{
    ...
    protected $fillable = ['id', 'codigo', 'transacao_pagarme', 'link_boleto', 'desconto_aplicado', 'valor_compra', 'quantidade', 'ip_compra', 'carrinho_abandonado', 'id_produto', 'id_cliente', 'id_forma_pagamento', 'id_endereco', 'id_nota', 'id_rastreamento', 'id_avaliacao', 'carrinho', 'created_at', 'updated_at'];
