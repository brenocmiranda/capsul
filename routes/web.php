...
// -------------------------------------------------
    Route::group(['prefix' => ''], function(){
        ...
        Route::get('notificationsAll', 'UsuariosCtrl@NotificacoesAll')->name('notificacoes.all')->middleware('auth');
        Route::get('notificationsRead/{id}', 'UsuariosCtrl@NotificacoesRead')->name('notificacoes.read')->middleware('auth');
        Route::get('notificationsReadAll', 'UsuariosCtrl@NotificacoesReadAll')->name('notificacoes.read.all')->middleware('auth');
